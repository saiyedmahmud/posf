      ...
      <section className='grid md:grid-cols-2 xl:grid-cols-4 gap-6 mt-5 mb-5'>
        <div className='ant-shadow dark:bg-[#2e2d35] flex items-center p-8 bg-white rounded-lg dashboard-card-bg '>
          ...
          <div>
            ...
            <span className='block text-gray-500 dark:text-yellow-50'> Total Invoices </span>
          </div>
        </div>
        <div className='ant-shadow dark:bg-[#2e2d35] flex items-center p-8 bg-white rounded-lg dashboard-card-bg'>
          <div className='inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-green-600 bg-green-100 rounded-lg mr-6'>
            <FaCoins size={30} />
          </div>
          <div>
            <span className='block text-2xl font-bold'>
            ...
            <span className='block text-gray-500 dark:text-yellow-50'>Total Amount</span>
          </div>
        </div>
        <div className='ant-shadow dark:bg-[#2e2d35] flex items-center p-8 bg-white rounded-lg dashboard-card-bg'>
          ...
          <div>
            ...
            <span className='block text-gray-500 dark:text-yellow-50'>Due Amount</span>
          </div>
        </div>
        <div className='ant-shadow dark:bg-[#2e2d35] flex items-center p-8 bg-white rounded-lg dashboard-card-bg'>
          ...
          <div>
            ...
            <span className='block text-gray-500 dark:text-yellow-50'>Total Paid Amount </span>
          </div>
        </div>
      </section>
    </Fragment>
