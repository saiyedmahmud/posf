        ...
        <div>
          ...
          <div className='border-gray-200 w-full rounded bg-white overflow-x-auto'>
            <table className='table report-section-table '>
              <thead className='text-gray-600 bg-slate-50 text-xs font-semibold border-gray tracking-wider text-left px-5 py-3 hover:cursor-pointer uppercase border-b-2 border-gray-200'>
                <tr className='border-b border-gray'>
                  <th
                    scope='col'
                    className='text-gray-200 border-gray border-b-2 border-t-2 border-gray-200 py-3 px-3 bg-gray-300 text-left text-xs font-semibold uppercase tracking-wider'
                  >
                    Account
                  </th>
                  <th
